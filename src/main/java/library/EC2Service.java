...
public interface EC2Service {
	 ...
	 * @return the Image object representing the AMI, or NULL if the AMI with the provided ID cannot be found in the current AWS region
	 ...
	 * @return an EC2 Instance object representing the Instance, or NULL if the Instance with the given ID cannot be found
	 * @throws AmazonServiceException if error occurred while calling AWS API
	 * @throws AmazonClientException if error occurred while calling AWS API
	 */
	 ...
	 * @return a KeyPairInfo object containing the details of the KeyPair, or NULL if the KeyPair with given Name cannot be found
	 * @throws AmazonServiceException if error occurred while calling AWS API
	 * @throws AmazonClientException if error occurred while calling AWS API
	 */
	 ...
	 * @return a SecurityGroup object representing the Security Group, or NULL if the SG with the given Name cannot be found
	 * @throws AmazonServiceException if error occurred while calling AWS API
	 * @throws AmazonClientException if error occurred while calling AWS API
	 */
	 ...
	 * @throws AmazonClientException if error occurred while calling AWS API
	 */
	public void revokeSecurityGroupInboundRule(String securityGroupName, String protocol, int port, String address) 
			throws AmazonServiceException, AmazonClientException;
	 ...
	 * @throws AmazonClientException if error occurred while calling AWS API
	 */
	public void addSecurityGroupInboundRule(String securityGroupName, String protocol, int port, String address) 
			throws AmazonServiceException, AmazonClientException;
