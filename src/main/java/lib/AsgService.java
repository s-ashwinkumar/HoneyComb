...
public interface AsgService {
  ...
  /**
   * Get the AutoScalingGroup object representing the ASG with the provided
   * Name.
   *
   * @param asgName the name of the ASG
   * @return the AutoScalingGroup object with the provided Name,
   * or NULL if no ASG with that name can be found
   ...
   *
   * @param asgName the name of the ASG
   * @return the LaunchConfiguration object associated with the ASG,
   * or NULL if either the ASG or the LaunchConfiguration cannot be found
   * @throws AmazonServiceException if error occurred while calling AWS API
   * @throws AmazonClientException  if error occurred while calling AWS API
   */
  public LaunchConfiguration getLaunchConfigurationForAutoScalingGroup(String
                                                                           asgName)
      throws AmazonServiceException, AmazonClientException;
   ...
   * @return the LaunchConfiguration object with the provided Name,
   * or NULL if a LC with that name cannot be found
   * @throws AmazonServiceException if error occurred while calling AWS API
   * @throws AmazonClientException  if error occurred while calling AWS API
   */
  ...
  /**
   * Get the list of Scaling Activities (both in progress and completed) of
   * the provided ASG.
   * The Scaling Activities that are in progress will appear first on the list.
   *
   * @param asgName the name of the ASG.
   * @return the list of Scaling Activities of the ASG, or NULL if the ASG
   * cannot be found.
   * @throws AmazonServiceException if error occurred while calling AWS API.
   * @throws AmazonClientException  if error occurred while calling AWS API.
   */
   ...
   * @return the EC2 Instance object of the "newest" instance launched,
   * or NULL if either ASG cannot be found or ASG contains no instance
   * @throws AmazonServiceException if error occurred while calling AWS API
   * @throws AmazonClientException  if error occurred while calling AWS API
   */
  public com.amazonaws.services.ec2.model.Instance getNewestEc2InstanceInAsg
  (String asgName)
      throws AmazonServiceException, AmazonClientException;
   ...
   */
  public String createLaunchConfiguration(CreateLaunchConfigurationRequest
                                              params)
      throws AmazonServiceException, AmazonClientException,
      IllegalArgumentException;
