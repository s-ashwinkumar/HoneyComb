...
public interface SSHService {
	 ...
	 * @param commands a list of Shell commands to be executed. The commands will be run one after another
	 * @throws IOException if an exception occur when trying to read the Key file or creating the SSH connection
	 */
