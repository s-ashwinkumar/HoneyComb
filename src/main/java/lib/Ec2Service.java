...
public interface Ec2Service {
   ...
   * , or NULL if the AMI with the provided ID cannot be found in the current
   * AWS region
   ...
   *
   * @param securityGroupName the name of the Security Group
   * @param protocol          the protocol of the rule we want to remove
   *                          (HTTP, HTTPS, SSH)
   ...
   *
   * @param securityGroupName the name of the Security Group
   * @param protocol          the protocol of the rule we want to add (HTTP,
   *                          HTTPS, SSH)
   * @param port              the port of the rule
   * @param address           the inbound address of the rule
   * @throws AmazonServiceException if error occurred while calling AWS API
