...
public class AmazonClientFactory {
	...
	private static AmazonAutoScaling autoScalingClient = Region.getRegion(Regions.US_EAST_1).
	...
	private static AmazonEC2 ec2Client = Region.getRegion(Regions.US_EAST_1).
			createClient(AmazonEC2Client.class, new EnvironmentVariableCredentialsProvider(), null);
	...
	/**
	 * Non-static method to obtain an AutoScaling client for call AWS AutoScaling API for Test purpose
	 * @return an AmazonAutoScaling client object
     */
	public AmazonAutoScaling getAmazonAutoScalingClientTest() { return autoScalingClient;}

	/**
	 * Non-static method to obtain an AutoScaling client for call AWS AutoScaling API for Test purpose
	 * @return an AmazonEC2 client object
     */
	public AmazonEC2 getAmazonEC2ClientTest() {return ec2Client;}


	/**
	 * Non-static method to obtain an AmazonElasticLoadBalancing client for Test purpose
	 * @return an AmazonElasticLoadBalancing client object
     */
